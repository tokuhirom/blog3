...
class UserSideServer(
    ...
    private val server =
        embeddedServer(Netty, port = 8180) {
            ...
            routing {
                ...
                get("/entry/{keys...}") {
                    ...
                    val entry =
                        publicEntryService.findPublicEntryByPath(path)
                ...
                get("/feed") {
                    val entries =
                        publicEntryService.findPublicEntries(
                            page = 1,
                            limit = 10,
                        )
            ...
            setupAdmin(adminEntryService, gitProperties, s3Service, contentService)
        }
...
class KtorRootConfiguration {
    ...
    ): UserSideServer = UserSideServer(gitProperties, publicEntryService, feedService, adminEntryService, s3Service, contentService)
}
